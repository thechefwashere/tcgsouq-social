---
title: "Deprecated Page insights metrics"
source: "https://developers.facebook.com/docs/platforminsights/page/deprecated-metrics"
final_url: "https://developers.facebook.com/documentation/pages-api/platforminsights/page/deprecated-metrics"
...
sha256: "5b619841160b47b47c18969894176d7b1141f2187f13e7b831c8a817232d22c9"
---

# Deprecated Facebook Page Insights Metrics



By June 15, 2025, the following Facebook Page Insights metrics were deprecated for all API versions. The API will return an invalid metric error when calling any of these metrics.
...
On November 15, 2025, the following Facebook Page Insights metrics were deprecated for all API versions. The API will return an invalid metric error when calling any of these metrics.
...
On March 14, 2024, the following Facebook Page Insights metrics were deprecated for all API versions. The API will return an invalid metric error when calling any of these metrics.
...
*  [Learn more about this deprecation.](https://developers.facebook.com/blog/post/2023/12/14/page-insights-metrics-deprecation)
